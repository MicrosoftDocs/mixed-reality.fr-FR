...
![Exemple : Lanceur d’applications 3D d’oiseau flottant](images/20171016-151526-mixedreality1-1200px-1000px.jpg)<br>
...
![Exemple : Nouveau lanceur d’applications 3D note](images/20171016-152145-mixedreality1-1200px-1000px.jpg)<br>
...
Le format de fin de votre lanceur d’application 3D est un fichier. GLB, qui est créé à l’aide du pipeline PBR (rendu physique). Il peut s’agir d’un processus délicat. à présent, nous vous conseillons d’employer un artiste technique si vous ne l’avez pas déjà fait. Si vous êtes un peu vos propres méthodes-er, prenez le temps de [Rechercher et d’apprendre la terminologie du PBR](http://wiki.polycount.com/wiki/PBR) et ce qui se passe en coulisse avant de commencer vous aidera à éviter les erreurs courantes. 

![Exemple : Nouvelle application note](images/pbr-freshnote1-640px-500px.png)<br>
*Exemple de lanceur d’application 3D note (application fictive)*
