...
![distance optimale pour placer les hologrammes de l’utilisateur.](images/distanceguiderendering-950px.png)<br>
...
Pour un maximum de confort, **la zone optimale pour le placement de l’hologramme est comprise entre 1,25 m et 5m**. Dans tous les cas, les concepteurs doivent tenter de structurer le contenu pour encourager les utilisateurs à interagir 1m ou plus loin du contenu (par exemple, ajuster la [taille du contenu et les paramètres de positionnement par défaut](gaze-and-commit.md)). 
...
Pour obtenir des instructions plus détaillées, consultez [typographie](typography.md) et [texte dans les pages Unity](text-in-unity.md) .
...
![champ de vision (angle de vue) autorisé, tel qu’il est déterminé par la plage de mouvement du cou](images/optimal-field-of-view-2.png)<br>
