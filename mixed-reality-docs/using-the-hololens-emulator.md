...
Versions : 
* [Émulateur HoloLens 2](https://go.microsoft.com/fwlink/?linkid=2101019).
...
* 8 Go de RAM minimum
* Dans le BIOS, les fonctionnalités suivantes doivent être [prises en charge et activées](http://blogs.technet.com/b/iftekhar/archive/2010/08/09/enable-hardware-settings-in-bios-to-run-hyper-v.aspx) :
...
## <a name="anatomy-of-the-hololens-1st-gen-emulator"></a>Anatomie de l’émulateur HoloLens (1ère génération)
...
Lors de l’installation de l’émulateur, vous pouvez rencontrer une erreur indiquant que vous devez utiliser *« Visual Studio 2015 Update 1 et les outils UWP version 1.2 »* . Cette erreur a trois causes possibles :
...
* Votre projet Visual Studio est configuré sur x86 (HoloLens 1ère génération) ou sur x86 ou x64 (émulateur HoloLens 2).
