...
### <a name="common-step-4-choose-the-correct-adapter"></a>Étape courante 4 : choisir l’adaptateur approprié
...
### <a name="unity-step-1-review-the-common-porting-steps-listed-above"></a>Opération Unity 1 : passer en revue les étapes de Portage courantes indiquées ci-dessus
...
### <a name="unity-step-4-target-your-application-to-run-on-win32"></a>Étape 4 : cibler votre application pour qu’elle s’exécute sur Win32
...
### <a name="unity-step-5-setup-your-windows-mixed-reality-hardware"></a>Étape 5 : configurer votre matériel Windows Mixed Reality
...
### <a name="unity-step-6-target-your-application-to-run-on-windows-mixed-reality"></a>Étape 6 : cibler votre application pour qu’elle s’exécute sur Windows Mixed Reality
...
### <a name="unity-step-7-use-the-stage-to-place-content-on-the-floor"></a>Étape 7 Unity : utiliser la phase pour placer le contenu à l’étage
...
### <a name="unity-step-8-work-through-your-input-model"></a>Step 8 : utiliser votre modèle d’entrée
...
### <a name="unity-step-9-performance-testing-and-tuning"></a>Étape 9 de l’unité Unity : test et réglage des performances
