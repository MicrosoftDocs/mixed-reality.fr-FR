...
>[!IMPORTANT]
>La communication à distance holographique pour HoloLens 2 est une modification majeure de la version. [Les applications hôtes pour **hololens (1re génération)** ](add-holographic-remoting.md) doivent utiliser le package NuGet version **1. x. x** et les [applications hôtes pour **hololens 2** ](holographic-remoting-create-host.md) doivent utiliser **2. x**. x. Cela implique que les applications hôtes écrites pour HoloLens 2 ne sont pas compatibles avec HoloLens (1ère génération) et vice versa.
