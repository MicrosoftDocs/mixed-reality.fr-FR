---
layout: LandingPage
title: Académie - code, des didacticiels et des leçons
description: L’Académie de réalité mixte fournit des exemples de code et des didacticiels sur le développement de réalité mixte.
author: keveleigh
ms.author: kurtie
ms.date: 03/21/2018
ms.topic: article
...
ms.locfileid: "59594582"
---
# <a name="academy-code-tutorials-and-lessons"></a>Academy : code, des didacticiels et des leçons
...
Nous avons également un Académie de réalité mixte en direct sur l’espace de réacteur à San Francisco. Si vous recherchez des informations sur l’espace de physique Academy, ou les événements à venir, [cliquez ici](#microsoft-reactor) ou faites défiler vers le bas de cette page.
...
<h3><a href="https://developer.microsoft.com/reactor/">Le Microsoft Reactor à San Francisco</a></h3>
<p>
Le Microsoft Reactor à San Francisco, situé à 680 Folsom dans SOMA, sert de l’emplacement de Phare pour le Studio de capturer de réalité mixte et de l’Académie de réalité mixte. C’est un endroit où les développeurs et les créateurs de peuvent vous aider à commencer son parcours de création d’expériences de réalité mixte pour Microsoft HoloLens et Windows Mixed Reality casques.</p>

[Recherchez les annonces de sessions à venir, les ateliers et hackathons](sf-academy-events.md)
