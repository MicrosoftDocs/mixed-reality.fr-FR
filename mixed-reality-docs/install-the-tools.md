...
Obtenez les outils dont vous avez besoin pour créer des applications Microsoft HoloLens et des casques immersifs Windows Mixed Reality. Il n’existe pas de SDK de développement Windows Mixed Reality. Vous allez donc utiliser Visual Studio avec le SDK Windows 10.
...
Nous vous recommandons d’installer le moteur de jeu Unity, car il s’agit du moyen le plus simple pour démarrer la création d’applications de réalité mixte. Toutefois, si vous souhaitez utiliser un moteur personnalisé, vous pouvez aussi utiliser DirectX.
...
Lorsque vous configurez votre ordinateur de développement pour HoloLens, vérifiez qu’il répond aux exigences de configuration du système pour <a href="https://unity3d.com/unity/system-requirements" target="_blank">Unity</a> et <a href="https://www.visualstudio.com/productinfo/vs2017-system-requirements-vs" target="_blank">Visual Studio</a>. Si vous prévoyez d’utiliser l’émulateur HoloLens (1ère génération), vérifiez également que votre ordinateur répond aux [exigences de configuration système de l’émulateur HoloLens ](using-the-hololens-emulator.md#hololens-emulator-system-requirements).
...
Si vous prévoyez de développer des applications pour HoloLens et pour les casques immersifs Windows Mixed Reality, suivez les recommandations et les exigences système fournies dans la section ci-dessous.

### <a name="for-immersive-vr-headset-development"></a>Développement pour casques immersifs

>[!NOTE]
>Les instructions suivantes constituent les spécifications minimales actuellement recommandées qui s’appliquent à votre *ordinateur de développement* pour casques immersifs. Ces instructions font l’objet de mises à jour régulières.
