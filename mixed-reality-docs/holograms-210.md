...
<td>Monsieur-entrée 210 : point de regard</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️</td>
</tr>
</table>
...
5. Vérifiez que **Windows Mixed Reality** s’affiche dans la liste. Si ce n’est pas le cas, sélectionnez le bouton **+** au bas de la liste et choisissez **Windows holographique**.
