...
5. Vérifiez que **Windows Mixed Reality** s’affiche dans la liste. Si ce n’est pas **+** le cas, sélectionnez le bouton en bas de la liste et choisissez **Windows Mixed Reality**.
...
4. Dans le composant **transformer** , remplacez **rotation** par (**X**: 45, **Y**: 45, **Z**: 45) et changer la mise à l' **échelle** en (**X**: 0,25, **Y**: 0,25, **Z**: 0,25). *Le cube est mis à l’échelle sur 0,25 mètres.*
