...
![Ajouter des fichiers aux fichiers/documents/HoloSketch/](images/holosketch-onedriveupload-1000px.png)
dossier![vous verrez ajouter un objet 3D dans le menu OneDrive de HoloSketch](images/holosketch-14-onedriveexample-1000px.jpg)
...
* **Espace** Ouvrez le menu OneDrive pour importer des objets.
