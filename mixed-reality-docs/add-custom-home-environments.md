...
---
# <a name="add-custom-home-environments"></a>Ajouter des environnements d’hébergement personnalisés
...
1. [Télécharger notre exemple d’environnement](https://download.microsoft.com/download/B/2/5/B25C1AEF-40CD-4B03-A596-4BCA3D33035A/Fantasy_Island.exe) d’îlots imaginaires (le lien pointe vers un exécutable à extraction automatique).
...
3. Ouvrez l' **Explorateur de fichiers** et accédez au dossier environnements en collant ce qui suit dans la barre d' `%LOCALAPPDATA%\Packages\EnvironmentsApp_cw5n1h2txyewy\LocalState`adresses:.
